/*@(#)CasAndShiroSingleSignOutFilter.java   2015-12-23 
 * Copy Right 2015 Bank of Communications Co.Ltd.
 * All Copyright Reserved
 */

package com.bankcomm.beijing.hr.shiro.cas.web;
...
/**
 * 由于cas的SingleSignOutFilter的 HANDLER是final的，无法继承修改或者注入，因此重写该类<br/>
 * 主要将原CAS的SingleSignOutFilter的HANDLER修改为MergedSingleSignOutHandler
 * <p>
 * @version 1.0.0,2015-12-23
 * @author lw
 * @since 1.0.0
 */
public class CasAndShiroSingleSignOutFilter extends AbstractConfigurationFilter{
	private static final MergedSingleSignOutHandler HANDLER = new MergedSingleSignOutHandler();
    ...
    public void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse,
        ...
        logger.debug("request path:{}",request.getPathTranslated());
        /**
    ...
    protected static MergedSingleSignOutHandler getSingleSignOutHandler() {
        return HANDLER;
    }
}
